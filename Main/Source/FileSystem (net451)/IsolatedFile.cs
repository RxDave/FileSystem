...
namespace FileSystem
{
  internal sealed class IsolatedFile : IFile
  {
    ...
    {
      return Task.FromResult(root.FileExists(path));
    }
    ...
    {
      return Task.FromResult<Stream>(root.OpenFile(path, FileMode.Open, forWriting ? FileAccess.ReadWrite : FileAccess.Read, FileShare.None));
    }
